...
export const validateWhileBasic = (
  code: string,
  output: string
  ...
  if (!hasContador) {
    return {
      isValid: false,
      message: 'Debes crear la variable contador = 1 como indica el ejercicio',
    };
  }
  ...
  if (!hasIncrement) {
    return {
      isValid: false,
      message: 'Debes incrementar el contador dentro del bucle. Ejemplo: contador = contador + 1',
    };
  }
...
export const validateWhileCounter = (
  code: string,
  output: string
): { isValid: boolean; message?: string } => {
  if (!code.trim()) {
  ...
  if (!hasNumero) {
    return {
      isValid: false,
      message: 'Debes crear la variable numero = 10 como indica el ejercicio',
    };
  }
  ...
  const hasCondition =
    /numero\s*>=\s*1/.test(code) || /1\s*<=\s*numero/.test(code) || /numero\s*>\s*0/.test(code);
  if (!hasCondition) {
    return {
      isValid: false,
      message: 'Debes usar una condición que permita contar del 10 al 1. Ejemplo: numero >= 1',
    };
  }
  ...
  if (!hasDecrement) {
    return {
      isValid: false,
      message: 'Debes decrementar el número dentro del bucle. Ejemplo: numero = numero - 1',
    };
  }
...
export const validateWhileSum = (
  ...
  if (!hasSuma || !hasNumero) {
    return {
      isValid: false,
      message: 'Debes crear las variables suma = 0 y numero = 1 como indica el ejercicio',
    };
  }
  ...
  if (!hasCondition) {
    return {
      isValid: false,
      message: 'Debes usar la condición "numero <= 10" en el while para sumar del 1 al 10',
    };
  }
  ...
  if (!hasAccumulate) {
    return {
      isValid: false,
      message: 'Debes acumular los números en la variable suma. Ejemplo: suma = suma + numero',
    };
  }
  ...
  if (!hasIncrement) {
    return {
      isValid: false,
      message: 'Debes incrementar numero dentro del bucle. Ejemplo: numero = numero + 1',
    };
  }
  ...
  if (outputNum !== 55) {
    return {
      isValid: false,
      message: 'La suma de los números del 1 al 10 debe ser 55. Verifica tu lógica',
    };
  }
...
export const validateWhileBreak = (
  code: string,
  output: string
): { isValid: boolean; message?: string } => {
  if (!code.trim()) {
  ...
  if (!hasNumero) {
    return {
      isValid: false,
      message: 'Debes crear la variable numero = 1 como indica el ejercicio',
    };
  }
  ...
  if (!hasCondition) {
    return {
      isValid: false,
      message: 'Debes verificar si numero > 5 para decidir cuándo usar break',
    };
  }
  ...
  if (!hasPrint) {
    return {
      isValid: false,
      message: 'Debes usar print() dentro del bucle para mostrar los números',
    };
  }
  ...
  if (lines.length < 5 || lines.length > 6) {
    return {
      isValid: false,
      message: 'Debes imprimir los números y luego salir con break cuando numero > 5',
    };
  }
