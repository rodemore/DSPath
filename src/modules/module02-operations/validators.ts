...
export const validateSumOperation = (
  code: string,
  output: string
  ...
  if (!hasNumAssignments) {
    return {
      isValid: false,
      message: 'Debes crear dos variables con números. Ejemplo: a = 10 y b = 20',
    };
  }
  ...
  if (!/^\d+$/.test(output.trim())) {
    return {
      isValid: false,
      message: 'El resultado debe ser un número. Asegúrate de sumar dos números',
    };
  }
...
export const validateRectangleArea = (
  code: string,
  output: string
): { isValid: boolean; message?: string } => {
  if (!code.trim()) {
  ...
  if (!hasBase || !hasAltura) {
    return {
      isValid: false,
      message:
        'Debes crear dos variables: base y altura con valores numéricos. Ejemplo: base = 8, altura = 5',
    };
  }
  ...
  if (!hasMultiplication) {
    return {
      isValid: false,
      message: 'Debes usar el operador * para calcular el área. Área = base * altura',
    };
  }
  ...
  if (!hasAreaVariable) {
    return {
      isValid: false,
      message:
        'Debes crear una variable llamada "area" con el resultado de base * altura. Ejemplo: area = base * altura',
    };
  }
  ...
  if (!/^\d+$/.test(output.trim())) {
    return {
      isValid: false,
      message:
        'El resultado debe ser un número. Asegúrate de multiplicar base * altura y guardar en area',
    };
  }
...
export const validatePowerOperation = (
  code: string,
  output: string
): { isValid: boolean; message?: string } => {
  if (!code.trim()) {
  ...
  if (!hasNumero || !hasExponente) {
    return {
      isValid: false,
      message: 'Debes crear dos variables: numero y exponente. Ejemplo: numero = 2, exponente = 3',
    };
  }
  ...
  if (!hasPower) {
    return {
      isValid: false,
      message: 'Debes usar el operador ** para calcular la potencia. Ejemplo: numero ** exponente',
    };
  }
  ...
  if (!/^\d+$/.test(output.trim())) {
    return {
      isValid: false,
      message: 'El resultado debe ser un número. Asegúrate de calcular numero ** exponente',
    };
  }
...
export const validateDivisionAndModulo = (
  code: string,
  output: string
): { isValid: boolean; message?: string } => {
  if (!code.trim()) {
  ...
  if (!hasDividendo || !hasDivisor) {
    return {
      isValid: false,
      message:
        'Debes crear dos variables: dividendo y divisor. Ejemplo: dividendo = 23, divisor = 4',
    };
  }
  ...
  if (!hasFloorDiv) {
    return {
      isValid: false,
      message:
        'Debes usar el operador // para división entera (cociente). Ejemplo: cociente = dividendo // divisor',
    };
  }
  ...
  if (!hasModulo) {
    return {
      isValid: false,
      message:
        'Debes usar el operador % para obtener el residuo. Ejemplo: residuo = dividendo % divisor',
    };
  }
  ...
  if (!hasCocienteVariable) {
    return {
      isValid: false,
      message:
        'Debes crear una variable llamada "cociente" con el resultado de dividendo // divisor',
    };
  }
  ...
  if (!hasResiduoVariable) {
    return {
      isValid: false,
      message: 'Debes crear una variable llamada "residuo" con el resultado de dividendo % divisor',
    };
  }
  ...
  if (printCount < 2) {
    return {
      isValid: false,
      message: 'Debes usar print() dos veces: una para el cociente y otra para el residuo',
    };
  }
