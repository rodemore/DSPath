...
export const validateForList = (
  ...
  if (!hasList) {
    return {
      isValid: false,
      message: 'Debes crear la lista colores = ["rojo", "azul", "verde"] como indica el ejercicio',
    };
  }
  ...
  if (!hasIn) {
    return {
      isValid: false,
      message: 'Debes usar "in" en el bucle for. Ejemplo: for color in colores:',
    };
  }
  ...
  if (!hasPrint) {
    return {
      isValid: false,
      message: 'Debes usar print() dentro del bucle para mostrar cada color',
    };
  }
  ...
  if (
    !outputLower.includes('rojo') ||
    !outputLower.includes('azul') ||
    !outputLower.includes('verde')
  ) {
    return {
      isValid: false,
      message: 'El output debe mostrar los tres colores: rojo, azul y verde',
    };
  }
...
export const validateForString = (
  code: string,
  output: string
): { isValid: boolean; message?: string } => {
  if (!code.trim()) {
  ...
  if (!hasPalabra) {
    return {
      isValid: false,
      message: 'Debes crear la variable palabra = "Python" como indica el ejercicio',
    };
  }
  ...
  if (!hasIn) {
    return {
      isValid: false,
      message: 'Debes usar "in" en el bucle for. Ejemplo: for letra in palabra:',
    };
  }
  ...
  if (!hasPrint) {
    return {
      isValid: false,
      message: 'Debes usar print() dentro del bucle para mostrar cada letra',
    };
  }
...
export const validateForRange = (
  ...
  if (!hasRange) {
    return {
      isValid: false,
      message: 'Debes usar la función range() en el bucle. Ejemplo: for i in range(1, 11):',
    };
  }
  ...
  if (!hasPrint) {
    return {
      isValid: false,
      message: 'Debes usar print() dentro del bucle para mostrar cada número',
    };
  }
...
export const validateForRangeSum = (
  code: string,
  output: string
): { isValid: boolean; message?: string } => {
  if (!code.trim()) {
  ...
  if (!hasList) {
    return {
      isValid: false,
      message: 'Debes crear la lista numeros = [5, 10, 15, 20, 25] como indica el ejercicio',
    };
  }
  ...
  if (!hasSuma) {
    return {
      isValid: false,
      message: 'Debes crear una variable suma = 0 antes del bucle para acumular los valores',
    };
  }
  ...
  if (!hasIn) {
    return {
      isValid: false,
      message: 'Debes usar "in" en el bucle for. Ejemplo: for numero in numeros:',
    };
  }
  ...
  if (outputNum !== 75) {
    return {
      isValid: false,
      message:
        'La suma de [5, 10, 15, 20, 25] debe ser 75. Verifica que estés acumulando correctamente',
    };
  }
...
export const validateForWithIf = (
  code: string,
  output: string
): { isValid: boolean; message?: string } => {
  if (!code.trim()) {
  ...
  // Verificar que crea la lista
  const hasList =
    /numeros\s*=\s*\[\s*12\s*,\s*7\s*,\s*23\s*,\s*8\s*,\s*15\s*,\s*30\s*,\s*5\s*\]/.test(code);
  if (!hasList) {
    return {
      isValid: false,
      message: 'Debes crear la lista numeros = [12, 7, 23, 8, 15, 30, 5] como indica el ejercicio',
    };
  }
  ...
  if (!hasIf) {
    return {
      isValid: false,
      message: 'Debes usar "if" dentro del bucle para verificar si el número es mayor a 10',
    };
  }
  ...
  if (!hasComparison) {
    return {
      isValid: false,
      message: 'Debes verificar si cada número es mayor a 10 (numero > 10)',
    };
  }
  ...
  if (outputNum !== 4) {
    return {
      isValid: false,
      message: 'Hay 4 números mayores a 10 en la lista (12, 23, 15, 30). Verifica tu lógica',
    };
  }
